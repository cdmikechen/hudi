...
public class HudiArrayWritableObjectInspector extends SettableStructObjectInspector {

  private static final HudiWritableTimestampMillisObjectInspector HWTOI_MILLIS =
      new HudiWritableTimestampMillisObjectInspector();
  private static final HudiWritableTimestampMicroObjectInspector HWTOI_MICROS =
          new HudiWritableTimestampMicroObjectInspector();

  private static final Logger LOG = LogManager.getLogger(HudiArrayWritableObjectInspector.class);
  ...
  private final String timestampLogicalType;

  // Whether this OI is for the column-level schema (as opposed to nested column fields).
  private final boolean isRoot;

  public HudiArrayWritableObjectInspector(final StructTypeInfo rowTypeInfo, String timestampLogicalType) {
    this(true, rowTypeInfo, null, timestampLogicalType);
  }

  public HudiArrayWritableObjectInspector(StructTypeInfo originalTypeInfo, StructTypeInfo prunedTypeInfo, String timestampLogicalType) {
    this(true, originalTypeInfo, prunedTypeInfo, timestampLogicalType);
  }

  public HudiArrayWritableObjectInspector(boolean isRoot,
                    StructTypeInfo originalTypeInfo, StructTypeInfo prunedTypeInfo, String timestampLogicalType) {
    this.isRoot = isRoot;
    ...
    this.timestampLogicalType = timestampLogicalType;
  ...
  private WritableTimestampObjectInspector getTimestampObjectInspector() {
    return HoodieHiveUtils.HUDI_TIMESTAMP_LOGICAL_TYPE_VALUE.equals(this.timestampLogicalType) ? HWTOI_MICROS : HWTOI_MILLIS;
  }
  ...
  private ObjectInspector getObjectInspector(
    ...
    if (typeInfo.equals(TypeInfoFactory.doubleTypeInfo)) {
      ...
      return new HudiArrayWritableObjectInspector(false, (StructTypeInfo) typeInfo, (StructTypeInfo) prunedTypeInfo,
          this.timestampLogicalType);
      ...
      return getTimestampObjectInspector();
  ...
  public boolean equals(Object o) {
    ...
    HudiArrayWritableObjectInspector that = (HudiArrayWritableObjectInspector) o;
